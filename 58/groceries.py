...
def create_parser():
    ...
    group.add_argument("-d", "--delete", type=str, help="delete a product by name (str)")
...
def handle_args(args=None, cart=None):
    ...
    if args.add:
        name, price, craving = args.add[0], int(args.add[1]), strtobool(args.add[2])
        cart.add(Item(name, price, craving))
