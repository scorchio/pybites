...
def edgy_doc():
    return Document().add_line("").swap_lines(0, 0).merge_lines([0]).add_punctuation(".", 0)
...
def doc(request):
    ...
    if request.param == "four-liner":
        return four_liner_doc()
    elif request.param == "tale":
        return tale_doc()
    elif request.param == "complex":
        return complex_doc()
    elif request.param == "edgy":
        return edgy_doc()
    elif request.param == "full-case":
        return full_case_doc()
    elif request.param == "punctuation":
        return punctuation_doc()
