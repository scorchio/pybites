...
class Document:
    ...
    def swap_lines(self, index_one: int, index_two: int) -> Document:
        ...
        """
        temp_line = self.lines[index_two]
    ...
    def merge_lines(self, indices: list) -> Document:
        ...
        for idx, line_idx in reversed(list(enumerate(indices))):
            if idx == 0:
    ...
    def add_punctuation(self, punctuation: str, index: int) -> Document:
        ...
        """
        if self.lines[index] and self.lines[index][-1] in EOL_PUNCTUATION:
    ...
    def words(self) -> list:
        ...
        for line in self.lines:
            ...
            line_split = lowercase_line.translate(str.maketrans('', '', string.punctuation)).split()
            words.update(line_split)
    ...
    def _remove_punctuation(self, line: str) -> str:
        ...
        for punctuation in EOL_PUNCTUATION:
